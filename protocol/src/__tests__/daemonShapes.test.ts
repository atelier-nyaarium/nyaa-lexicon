...
describe("questionsFor", () => {
	it("gives a running kind every question, in order", () => {
		for (const kind of ["function", "method", "constructor", "operator"] as const) {
			const questions = questionsFor({ kind, local: false });
