...
const CASES: ConformanceCase[] = [
		...
		fixtures: {
			...
			[CSHARP]: {
				files: {
					"src/cart/Owners.cs": [
						"using Imported;",
						"public class Typed<T> where T : Bound { }",
						"public class Owners { public Result sign(Param x, int y = limit) => null; public const int limit = 1; }",
						"public class Deep : Base { }",
						"",
					].join("\n"),
				},
				subject: "src/cart/Owners.cs",
			},
		},
		references: [
	...
	{
		id: "decorator-and-signature-uses-belong-to-their-declaration",
		tier: "binding",
		about: "A use in a declaration's header is written in that declaration.",
		fixtures: {
			[PYTHON]: {
				files: {
					"src/owners.py": [
				...
				subject: "src/owners.py",
			},
		},
		references: [
			{ name: "deco", at: { line: 8 }, from: "Holder" },
			{ name: "Base", role: "extends", from: "Holder" },
			{ name: "deco", at: { line: 10 }, from: "method" },
			{ name: "Base", role: "typeUse", at: { line: 11, character: 24 }, from: "method" },
			{ name: "LIMIT", at: { line: 11 }, from: "method" },
			{ name: "Base", role: "typeUse", at: { line: 11, character: 41 }, from: "method" },
			{ name: "deco", at: { line: 14 }, from: "free" },
			{ name: "Base", role: "typeUse", at: { line: 15, character: 12 }, from: "free" },
			{ name: "LIMIT", at: { line: 15 }, from: "free" },
			{ name: "Base", role: "typeUse", at: { line: 15, character: 29 }, from: "free" },
			{ name: "LIMIT", at: { line: 0 }, from: null },
		],
	},
	{
		id: "attribute-uses-belong-to-the-attributed-declaration",
		tier: "binding",
		about: "A use in an attribute, its name or an argument, is written in the declaration the attribute sits on; an assembly attribute is written in none.",
		fixtures: {
			[CSHARP]: {
				files: {
					"src/attributed.cs": [
				...
				subject: "src/attributed.cs",
			},
		},
		declarations: [
			{ name: "One", kind: "constant", container: "Kinds" },
			{ name: "Two", kind: "constant", container: "Kinds" },
			{ name: "T", kind: "typeParameter", container: "Generic" },
		],
		references: [
			{ name: "Marker", role: "typeUse", at: { line: 1 }, from: null, bindsTo: "MarkerAttribute" },
			{ name: "Marker", role: "typeUse", at: { line: 4 }, from: "Holder", bindsTo: "MarkerAttribute" },
			{ name: "Base", role: "typeUse", at: { line: 4 }, from: "Holder", bindsTo: "Base" },
			{
				name: "Marker",
				role: "typeUse",
			...
			{ name: "Marker", role: "typeUse", at: { line: 8 }, from: "Method", bindsTo: "MarkerAttribute" },
			{ name: "Marker", role: "typeUse", at: { line: 9 }, from: "Field", bindsTo: "MarkerAttribute" },
			{ name: "Limit", role: "read", at: { line: 9 }, from: "Field", bindsTo: "Limit" },
			{ name: "Marker", role: "typeUse", at: { line: 11 }, from: "One", bindsTo: "MarkerAttribute" },
			{ name: "Marker", role: "typeUse", at: { line: 12 }, from: "Generic", bindsTo: "MarkerAttribute" },
		],
		parseErrors: "forbidden",
	},
	{
	...
	},
	{
		...
		fixtures: {
			[PYTHON]: {
				...
				subject: "src/nested.py",
			},
		},
		references: [
			{ name: "LIMIT", at: { line: 4 }, from: "method" },
			{ name: "LIMIT", at: { line: 8 }, from: "inner" },
			{ name: "Later", role: "typeUse", from: "early" },
		],
	},
	{
		id: "type-parameter-bounds-belong-to-their-declaration",
		tier: "binding",
		about: "A use in a type parameter's bound or constraint tuple is written in the declaration the parameter list heads, and resolves outside it.",
		fixtures: {
			[PYTHON]: {
				files: {
					"src/bounds.py": [
				...
				subject: "src/bounds.py",
			},
		},
		references: [
			{ name: "Bound", role: "typeUse", at: { line: 6 }, from: "Typed", bindsTo: "Bound" },
