...
import {
	...
	REFACTOR_PREVIEW_DESCRIPTION,
	REFACTOR_RENAME_DESCRIPTION,
	REFACTOR_REPLACE_DESCRIPTION,
	REFACTOR_REVERT_DESCRIPTION,
	REFACTOR_START_DESCRIPTION,
	REFACTOR_STATUS_DESCRIPTION,
	REFACTOR_TRACK_DESCRIPTION,
...
export const PROJECT_TOOL_DEFINITIONS = [
	...
	},
	{
		...
		scope: "mutation",
		input: {},
		handler: (backend: ToolBackend) => refactorStart(backend),
	},
	{
		...
		batch: false,
		input: {},
		handler: (backend: ToolBackend) => refactorStatus(backend),
	},
	{
	...
	},
	{
		...
		scope: "mutation",
		input: {},
		handler: (backend: ToolBackend) => refactorUndo(backend),
	},
	{
